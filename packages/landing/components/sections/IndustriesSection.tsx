    ...
    <section id="industries" className="py-20 lg:py-28 relative overflow-hidden">
      ...
      <Container>
        <AnimatedSection>
          <SectionHeading
            eyebrow="Industries"
            title="Built for Indian Service Businesses"
        ...
        <StaggerContainer className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-5">
          {INDUSTRIES.map((industry) => (
            <AnimatedItem key={industry.name}>
              <div className="group rounded-2xl border border-slate-200 bg-white p-5 text-center transition-all duration-300 hover:border-brand-300 hover:shadow-lg hover:-translate-y-1">
